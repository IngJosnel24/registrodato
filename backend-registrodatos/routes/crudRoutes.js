...
//curl http://localhost:5000/crud/MiTabla/read
...
//curl -X POST -H "Content-Type: application/json" -d '{"nombre": "Izayana Umaña", "edad": 20, "email": "izayana121123@gmail.com"}' http://localhost:5000/crud/MiTabla/create
  ...
  router.post('/create', (req, res) => {
    ...
    const sql = `INSERT INTO MiTabla (nombre, edad, email) VALUES (?, ?, ?)`;
    const values = [nombre, edad, email];
